<x-layout-content class="w-full flex justify-around items-center fixed z-20 sm:z-0 sm:sticky sm:top-20 sm:block bottom-0 sm:w-[20%] overflow-hidden h-20 sm:rounded-lg sm:h-auto">
    {{-- Beranda --}}
    ...
    <div>
        ...
        <div x-show="open"
        class="fixed inset-0 bg-gray-900 bg-opacity-75 flex items-center justify-center z-70"
        @keydown.escape.window="open = false"
        style="display: none;">

            {{-- Modal Content --}}
            <div class="bg-white z-30 dark:bg-gray-800 w-11/12 sm:w-3/4 lg:w-[70%] xl:w-[40%] rounded-lg p-6 sm:p-4 lg:p-6 relative" @click.outside="open = false">
